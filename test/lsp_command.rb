...
assert('lsp_goto_command') do
  ...
  app.ext.data['lsp']['default'] = LSP::Client.new('ruby', {'args' => [File.dirname(__FILE__)+'/../misc/dummy_lsp.rb']})
  app.ext.data['lsp']['default'].server_capabilities['hogehogeProvider'] = false
  ...
  app.ext.data['lsp']['default'].server_capabilities['definitionProvider'] = true
